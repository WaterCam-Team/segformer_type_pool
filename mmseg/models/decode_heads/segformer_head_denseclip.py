...
class SegFormerHead_denseclip(BaseDecodeHead):
    """
    SegFormer: Simple and Efficient Design for Semantic Segmentation with Transformers
    """
    def __init__(self, feature_strides, K_water, K_bg,use_text=False,use_visual=False,**kwargs):
        super(SegFormerHead_denseclip, self).__init__(input_transform='multiple_select', **kwargs)
        ...
        self.linear_c4 = MLP(input_dim=c4_in_channels+2, embed_dim=embedding_dim)
        self.linear_c3 = MLP(input_dim=c3_in_channels, embed_dim=embedding_dim)
        self.linear_c2 = MLP(input_dim=c2_in_channels, embed_dim=embedding_dim)
        self.linear_c1 = MLP(input_dim=c1_in_channels, embed_dim=embedding_dim)
        # self.linear_c3 = MLP(input_dim=c3_in_channels+2, embed_dim=embedding_dim)
        # self.linear_c2 = MLP(input_dim=c2_in_channels+2, embed_dim=embedding_dim)
        ...
        if self.use_text:
            ...
            self.register_buffer("E_WATER", clip_text_embeddings)  # stays frozen
    ...
    def forward(self, inputs):
        ...
        if self.use_text:
            pixel_feat = self.proj_to_clip(_c)                              # [B,512,H,W]
            ...
            x = torch.einsum('bchw,bkc->bkhw', pixel_feat, text_feat)
        elif self.use_visual:
